return {
    ...
    descriptions = {
        Joker = {
            j_egocentrism = {
                ...
                text = {
                    ...
                    "{C:attention}Эгоцентризм{}. Превращает",
                    "случайного {C:attention}джокера{} в {C:attention}Эгоцентризм",
                    "при выборе {C:attention}блайнда{}",
                    "{C:inactive}(Сейчас {C:chips}+#2#{C:inactive} фишек)"
                }
            },
            j_eulogy = {
                name = "Надгробная речь Ноля",
                text = {
                    "В {C:attention}магазине{} карты с шансом {C:green}#1# из #2#",
                    "{C:attention}переворачиваются", 
                    "Скидка {C:attention}50%"
                }
            },
            j_crown = {
                name = "Хрупкая коронка",
                text = {
                    "Сыгранные карты шансом {C:green}#1# из #2#",
                    "дают {C:money}$#3#{} при подсчете",
                    "В конце раунда теряешь {C:money}$#3#",
                    "за каждую {C:attention}руку{} и {C:attention}сборс"
                }
            },
            j_shaped = {
                name = "Хрупкое стекло",
                text = {
                    "Перезапуска всех сыгранных",
                    "{C:attention}Стекляных{} карт, но",
                    "шанс их уничтожения",
                    "увеличен до {C:green}#1# из #2#{}"
                }
            },
            j_snake_eyes = {
                name = "Змеиные глаза",
                text = {
                    ...
                    "{C:tarot}Колесо Фортуны{} не срабатывает",
            ...
            j_bungus = {
                name = "Шумный гриб",
                text = {
                    "После {C:attention}#1#{} раундов, добавялет",
                    "{C:dark_edition}Фольговый{} выпуск",
                    "джокерам рядом с ним",
                    "{C:inactive}(Сейчас {C:attention}#2#{C:inactive}/#1#)"
                }
            },
            j_benthic = {
                name = "Бентическое цветение",
                text = {
                    "Улучшает {C:attention}1{} случайного {C:attention}джокера{}",
                    "в {C:attention}джокера{} следующей",
                    "{C:attention}редкости{}, когда",
                    "{C:attention}босс блайнд{} побежден"
                }
            },
            j_encrusted = {
                name = "Инкрустированный ключ",
                text = {
                    "После победы над",
                    "{C:attention}босс блайндом{}, эта карта",
                    "уничтожается и дает",
                    "{C:attention}#1#"
                }
            },
            j_kjaro = {
                name = "Группа Кьяро",
                text = {
                    "{X:mult,C:white} X#1# {} множ., если фишки",
                    "подсчитанные в последнеё руке",
                    "было больше {C:attention}X#2#",
                    "от необходимых"
                }
            },
            j_daisy = {
                name = "Лептонная маргаритка",
                text = {
                    "{C:chips}+#1#{} фишек за каждую",
                    "{C:attention}ослабленную{} карту",
                    "в сыгранной руке",
                }
            },
            j_duplicator = {
                name = "Некачественный принтер",
                text = {
                    "При получении {C:attention}джокера{},",
                    "создает его {C:dark_edition}негативную",
                    "{C:dark_edition}временную{} копию"
                }
            },
            j_happiest_mask = {
                name = "Самая счастливая маска",
                text = {
                    "Шанс {C:green}#1# из #2#{} создать",
                    "случайную {C:spectral}спектральную{} карту",
                    "при уничтожении любой карты",
        ...
        Blind = {
            bl_loop = {
                name = "Петля",
                text = {
                    "Случайный джокер отключается",
                    "после 2 сыгранных рук"
                }
            },
            bl_void = {
                name = "Пустота",
                text = {
                    "В случае поражения изменяет",
                    "стоимость всех джокеров на 0"
                }
            },
            bl_bag = {
                name = "Сумка",
        ...
        Voucher = {
            v_3d_printer = {
                name = "3D-принтер",
                text = {
                    "Все {C:attention}Бустерные наборы",
                    "имеют на {C:attention}1{} больше карт"
                }
            },
            v_militech_printer = {
                name = "Принтер Mili-Tech",
                text = {
                    "Можно выбрать еще {C:attention}1",
                    "карту в каждом",
                    "{C:attention}Бустерном наборе"
                }
            }
        },
        Other = {
    ...
    misc = {
        dictionary = {
            k_broken_ex = "Сломано!",
            k_converted_ex = "Превращен!",
            k_voided_ex = "Аннулирован!",
            ph_kjaro_disabled = "не хватает фишек"
        },
        labels = {
            temporary = "Временно"
        }
